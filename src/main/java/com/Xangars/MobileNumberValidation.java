...
public class MobileNumberValidation implements Processor {
    ...
    public void process(Exchange exchange) throws Exception {
        ...
        try {
            ...
            //ChangeRequest Mobilevalidate  = new ChangeRequest();
...
//            String DateOfInitiation = getDate();
            ...
            for(int i = 0; i<jsonarr.size();i++) {
                ...
                if(!Validator.validateMobileNumber((mobiledetails.getMOBILE_NUMBER()))) {
                    ...
                    try{
                        ...
                        while(rs.next())  {
                            recordFound=true;
                            mobiledetails.setMOBILE_NUMBER(rs.getString("MOBILE_NUMBER"));
                        ...
                        if (recordFound){
                            ...
                            mobiledetails.setMESSAGE("Incorrect MOBILE NUMBER OR  DOB provided");
                        }
            ...
            policystr = gson.toJson(mobiledetails);
